...
public class FollowUsuarioRequest extends StringRequest {

    private static final String LOGIN_REQUEST_URL = IPrequest.getSeguidor() + "FollowUser.php";
    ...
    public FollowUsuarioRequest(String id_User, String id_follow, Response.Listener<String> listener){
