...
public class CheckableImageButao extends ImageButton implements Checkable {
    ...
    public CheckableImageButao(Context context) {
        this(context, null);
    }

    public CheckableImageButao(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public static interface OnCheckedChangeListener {
         ...
         */
        void onCheckedChanged(CheckableImageButao button, boolean isChecked);
    }
